...
<table width="100%">
  <tr> <!-- 위 -->
	...
	<jsp:include page="include/right2.jsp" flush="false" />
	</td>
  </tr>
  <tr> <!-- 왼쪽 -->
  	<td valign="top" width="100">
  	<jsp:include page="include/left2.jsp" flush="false" />
	<img src="img/bottom.png" width="300" height="300" border="0" align="bottom"/>
  	</td>
